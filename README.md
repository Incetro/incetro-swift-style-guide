# The Official Incetro Swift Style Guide.
...
Setup page guide in Xcode for 150 symbols. This number is recommended in swiftlint settings. So all code should be inside this page guide.
...
Where an Xcode project is involved, the organization should be set to `Redmadrobot` and the Bundle Identifier set to `com.incetro.ProjectName` where `ProjectName` is the name of your project.
